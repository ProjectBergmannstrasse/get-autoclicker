#!/usr/bin/env python3
"""AutoClicker v013 — ProjectBergmannstrasse — + separator"""
...
root = tk.Tk()
root.title("AutoClicker v013")
root.geometry("300x328")
...
tk.Frame(root, height=2, bg="#888888").pack(fill="x", padx=20, pady=6)
