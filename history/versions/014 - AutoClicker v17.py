#!/usr/bin/env python3
"""AutoClicker v017 — ProjectBergmannstrasse — + button dropdown"""
...
L("Button:").pack()
btn_var = tk.StringVar(value="left"); tk.OptionMenu(root, btn_var, "left", "right").pack()
