#!/usr/bin/env python3
"""AutoClicker v031 — ProjectBergmannstrasse — dark cyan titles"""
...
tk.Button(root, text="Start", command=do_start, fg="#eeeeff").pack(pady=3)
tk.Button(root, text="Stop", command=do_stop, fg="#eeeeff").pack(pady=3)
