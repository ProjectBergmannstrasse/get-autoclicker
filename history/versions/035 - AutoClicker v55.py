#!/usr/bin/env python3
"""AutoClicker v055 — ProjectBergmannstrasse — all footers"""
...
def show_about():
    ...
    tk.Label(w, text="AutoClicker v055", bg="#0c0c18", fg="#00c8f0",
...
L("sha256: 9f8e7d6c5b4a...", fg="#3a3a5a", font=("Arial", 8)).pack()
L("github.com/ProjectBergmannstrasse", fg="#00c8f0", font=("Arial", 8)).pack()
L("BTC · ETH · SOL", fg="#5a5a7a", font=("Arial", 8)).pack()
tk.Label(root, text=" ready", bg="#161625", fg="#5a5a7a", anchor="w").pack(side="bottom", fill="x")
